<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=4344319fc9448082746e64d661fb0d2c&libraries=services"></script>
        <style>
            table,
            tr,
            td,
    ...
    <body>
        <div id="app">
            ...
            <div>
                <select v-model="placeSelect" @change="fnMapInit">
        ...
        const app = Vue.createApp({
            ...
            methods: {
                ...
                fnMapInit: function () {
                    ...
                    this.ps.categorySearch(this.placeSelect, this.placesSearchCB, { useMapBounds: true });
